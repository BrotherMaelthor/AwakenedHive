...
script.on_init(function()
    ...
    if (settings.global["AwakenedHive-Difficulty"].value == "Easy") then global.MAXGROUPS = 20
    elseif (settings.global["AwakenedHive-Difficulty"].value == "Normal") then global.MAXGROUPS = 40
    elseif (settings.global["AwakenedHive-Difficulty"].value == "Hard") then global.MAXGROUPS = 60
    elseif (settings.global["AwakenedHive-Difficulty"].value == "Extreme") then global.MAXGROUPS = 100 end
end)
...
script.on_nth_tick(216000, function()
    if (settings.global["AwakenedHive-BiterCleanup"].value == true) then 
